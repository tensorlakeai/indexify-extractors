...
class GenAIExtractorConfig(BaseModel):
    llm: str = "openai"
    key: str = None
...
class GenAIExtractor(Extractor):
    ...
    def __init__(self):
        super(GenAIExtractor, self).__init__()

    def extract(self, content: Content, params = GenAIExtractorConfig) -> List[Union[Feature, Content]]:
        contents = []
...
if __name__ == "__main__":
    ...
    input_params = GenAIExtractorConfig(llm="openai", key="", prompt=prompt)
