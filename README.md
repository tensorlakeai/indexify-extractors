...
extractor, config_cls = load_extractor("indexify_extractor.minilm-l6.minilm_l6:MiniLML6Extractor")
...
```python
ex, config = load_extractor("indexify_extractor.chunking.chunk_extractor:ChunkExtractor")
config.schema()
