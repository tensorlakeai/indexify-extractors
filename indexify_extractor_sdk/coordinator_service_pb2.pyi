...
class ListTasksRequest(_message.Message):
    ...
    def __init__(self, repository: _Optional[str] = ..., extractor_binding: _Optional[str] = ...) -> None: ...
...
class GetIndexRequest(_message.Message):
    ...
    repository: str
    name: str
    def __init__(self, repository: _Optional[str] = ..., name: _Optional[str] = ...) -> None: ...
...
class Index(_message.Message):
    __slots__ = ("name", "repository", "table_name", "schema", "extractor_binding", "extractor")
    NAME_FIELD_NUMBER: _ClassVar[int]
    REPOSITORY_FIELD_NUMBER: _ClassVar[int]
    ...
    extractor_binding: str
    extractor: str
    def __init__(self, name: _Optional[str] = ..., repository: _Optional[str] = ..., table_name: _Optional[str] = ..., schema: _Optional[str] = ..., extractor_binding: _Optional[str] = ..., extractor: _Optional[str] = ...) -> None: ...
...
class Task(_message.Message):
    __slots__ = ("id", "extractor", "repository", "content_metadata", "input_params", "extractor_binding", "output_index_mapping", "outcome")
    ...
    outcome: TaskOutcome
    def __init__(self, id: _Optional[str] = ..., extractor: _Optional[str] = ..., repository: _Optional[str] = ..., content_metadata: _Optional[_Union[ContentMetadata, _Mapping]] = ..., input_params: _Optional[str] = ..., extractor_binding: _Optional[str] = ..., output_index_mapping: _Optional[_Mapping[str, str]] = ..., outcome: _Optional[_Union[TaskOutcome, str]] = ...) -> None: ...
...
class ListContentRequest(_message.Message):
    ...
    def __init__(self, repository: _Optional[str] = ..., source: _Optional[str] = ..., parent_id: _Optional[str] = ..., labels_eq: _Optional[_Mapping[str, str]] = ...) -> None: ...
...
class ListBindingsResponse(_message.Message):
    ...
    def __init__(self, bindings: _Optional[_Iterable[_Union[ExtractorBinding, _Mapping]]] = ...) -> None: ...
...
class CreateRepositoryRequest(_message.Message):
    ...
    name: str
    bindings: _containers.RepeatedCompositeFieldContainer[ExtractorBinding]
    def __init__(self, name: _Optional[str] = ..., bindings: _Optional[_Iterable[_Union[ExtractorBinding, _Mapping]]] = ...) -> None: ...
...
class ExtractorBindRequest(_message.Message):
    ...
    created_at: int
    def __init__(self, repository: _Optional[str] = ..., binding: _Optional[_Union[ExtractorBinding, _Mapping]] = ..., created_at: _Optional[int] = ...) -> None: ...
...
class ContentMetadata(_message.Message):
    __slots__ = ("id", "file_name", "parent_id", "mime", "labels", "storage_url", "created_at", "repository", "source")
    ...
    repository: str
    source: str
    def __init__(self, id: _Optional[str] = ..., file_name: _Optional[str] = ..., parent_id: _Optional[str] = ..., mime: _Optional[str] = ..., labels: _Optional[_Mapping[str, str]] = ..., storage_url: _Optional[str] = ..., created_at: _Optional[int] = ..., repository: _Optional[str] = ..., source: _Optional[str] = ...) -> None: ...
