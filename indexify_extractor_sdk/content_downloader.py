...
def download_content(content_metadata:coordinator_service_pb2.ContentMetadata) -> Content:
    ...
    return Content(content_type=content_metadata.mime, data=data, labels=content_metadata.labels, features=[])